...
repeats = range(1,11) ##range(1,11) test 1 to 6 
start_times = [50, 60, 70, 75, 80, 100, 120, 125, 140, 150, 160, 175, 180, 200, 220, 225, 250, 260, 275, 280, 300, 320, 325, 340, 350, 360, 375, 380, 400, 410, 420, 425, 440, 450, 460, 470, 475, 480, 500]
...
for tp in time_points:
    ...
    pdb_filename = f'pdbs/550_1SD_1A0_{tp}.pdb'
