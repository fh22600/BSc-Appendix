...
# 50, 60, 75, 80, 100, 120, 125, 140, 150, 160, 175, 180, 200, 220, 225, 250, 260, 275, 280, 300, 320, 325, 340, 350, 360, 375, 380, 400, 420, 425, 440, 450, 460, 475, 480, 500
...
time_points =  [110,120,130,140,150,170,200,250,300,350,400,450,500,750,1000] ## as a test, ask which are best
...
for tp in time_points:
    ...
    for run in runs:
        for time in times:
            try:
                ...
                ## ^^ equilibrium dumps
                other = mda.Universe(f'Repeat_{run}/ns_{time}/md{time}_{tp}.pdb')
    ...
    # Write summary stats
    with open(f"vec_norm_txt/550_1SD_1A0_298_strip_6NB_vec_norm_{tp}.txt", 'w') as f:
       # Write header
       f.write("#" * 128 + "\n")
    ...
    #pdb_filename = f'pdbs/180_1A0_vec_norm_{tp}.pdb'
