...
times = [50, 60, 70, 75, 80, 90, 100, 110, 120, 125, 130, 140, 150, 160, 175, 180, 190, 200,210, 220, 225, 230, 240, 250, 260, 275, 280, 290, 300,310, 320, 325, 340, 350, 360, 375, 380, 390, 400, 410, 420, 425, 430, 440, 450, 460, 470, 475, 480, 490,500]
...
for tp in time_points:
    ...
    # Write summary stats
    with open(f"test_vec_stats_{tp}.txt", 'w') as f:
    ...
    gro_filename = f'gro_files/1A5_6NB_strip_TS_avg_vec_{tp}.gro'
